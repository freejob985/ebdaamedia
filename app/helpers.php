     ...
     function embed($url)
{
    ...
    return $youtube = "<iframe  src='https://www.youtube.com/embed/$a' style='width:100%;height:280px;' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
    // Output: C4kxS1ksqtw
}
