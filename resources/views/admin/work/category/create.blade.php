                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{ route('work-category.edit', $category->id) }}" class="mr-2">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form class="d-inline-block" action="{{ route('work-category.destroy', $category->id) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
                    ...
                    <form action="{{ route('work-category.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
        <textarea  placeholder="Please enter data  Links" name="Links"   style="resize: none;font-size: 18px;font-weight: 600;color: white !important;background: #0e1726;"class="form-control" rows="5" id="comment"></textarea>
        @if ($errors->has('explanation'))
        <span class="helper-text" data-error="wrong" data-success="right">{{ $errors->first('Links') }}</span>
        @endif
      </div>
