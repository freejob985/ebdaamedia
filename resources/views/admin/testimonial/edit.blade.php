                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="desc" class="form-control" id="desc">{{ $testimonial->desc }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="testimonial_image">{{ __('content.image') }} ({{ __('content.size') }} 250 x 312) (.svg, .jpg, .jpeg, .png)</label>
