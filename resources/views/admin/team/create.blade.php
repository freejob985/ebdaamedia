                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="top_title" class="form-control" id="top_title" value="{{ $team_section->top_title }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                ...
                <div class="modal-body">
                    <form action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="team_image">{{ __('content.image') }} ({{ __('content.size') }} 245 x 250) (.svg, .jpg, .jpeg, .png)</label>
