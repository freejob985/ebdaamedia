                    ...
                    <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="url" class="form-control" id="order" value="" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="gallery_image">{{ __('content.image') }} ({{ __('content.size') }} 450 x 475) (.svg, .jpg, .jpeg, .png , video) <span class="text-red">*</span></label>
