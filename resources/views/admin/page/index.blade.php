                            ...
                            @foreach ($pages as $page)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($page->display_footer_menu == 1)
                                            ...
                                            <input type="text" value="{{ url('/'.$page->page_slug) }}" id="copyLink">
                                            <button class="btn btn-success" onclick="copyLink()">{{ __('Copy Link') }}</button>
                                        @endif
                                    </td>
                                    <td>
                                        <div>
