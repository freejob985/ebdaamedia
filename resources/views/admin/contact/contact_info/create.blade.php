            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (isset($contact_section))
                        <form action="{{ route('contact-section.update', $contact_section->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="contact_image">{{ __('content.image') }} ({{ __('content.size') }} 840 x 750) (.svg, .jpg, .jpeg, .png)</label>
                                        <input type="file" name="contact_image" class="form-control-file" id="contact_image">
                                        <small id="contact_image" class="form-text text-muted">{{ __('content.recommended_size') }}</small>
                                    </div>
                                                    ...
                                                    <div class="media">
                                                        @if (!empty($contact_section->contact_image))
                                                            <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                <img src="{{ asset('uploads/img/general/'.$contact_section->contact_image) }}" alt="contact image" class="rounded w-25">
                                                            </a>
                                                        @else
                                                            <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                    ...
                    @else
                        <form action="{{ route('contact-section.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
