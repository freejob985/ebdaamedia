                ...
                @if (isset($site_image))
                    <form action="{{ route('site-image.update', $site_image->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="site_colored_logo_image">{{ __('content.site_white_logo_image') }} ({{ __('content.size') }} 160 x 44) (.svg, .jpg, .jpeg, .png)</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="site_white_logo_image">{{ __('content.site_colored_logo_image') }} ({{ __('content.size') }} 160 x 44) (.svg, .jpg, .jpeg, .png)</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="site_small_logo_image">{{ __('content.site_small_logo_image') }} ({{ __('content.size') }} 100 x 35) (.svg, .jpg, .jpeg, .png)</label>
                                    <input type="file" name="site_small_logo_image" class="form-control-file" id="site_small_logo_image">
                                    <small id="site_small_logo_image" class="form-text text-muted">{{ __('content.recommended_size') }}</small>
                                </div>
                                <div class="height-card box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->site_small_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/img/general/'.$site_image->site_small_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                        <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                            <img src="{{ asset('uploads/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="site_footer_logo_image">{{ __('content.site_footer_logo_image') }} ({{ __('content.size') }} 44 x 44) (.svg, .jpg, .jpeg, .png)</label>
                                    <input type="file" name="site_footer_logo_image" class="form-control-file" id="site_footer_logo_image">
                                    <small id="site_footer_logo_image" class="form-text text-muted">{{ __('content.recommended_size') }}</small>
                                </div>
                                <div class="height-card box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->site_footer_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/img/general/'.$site_image->site_footer_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                        <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                            <img src="{{ asset('uploads/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
